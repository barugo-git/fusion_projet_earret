...
!function (o) {
    ...
    function d(t, e) {
        ...
        this.c = f.extend(!0, {}, p.defaults.autoFill, d.defaults, e), this.s = {
            dt: new p.Api(t),
            ...
            list: f('<div class="dt-autofill-list">' + this.s.dt.i18n("autoFill.info", "") + "</div>").attr("aria-modal", !0).attr("role", "dialog").append('<div class="dt-autofill-list-items"></div>'),
            dtScroll: null,
            offsetParent: null
        }, this._constructor()
    }

    var p = f.fn.dataTable, o = 0, t = (f.extend(d.prototype, {
        enabled: function () {
            return this.s.enabled
        }, enable: function (t) {
            var e = this;
            if (!1 === t) return this.disable();
            this.s.enabled = !0, this._focusListener(), this.dom.handle.on("mousedown touchstart", function (t) {
            ...
            function o() {
                e.s.handle = {height: !1, width: !1}, f(e.dom.handle).css({
                    height: "",
                    width: ""
                }), void 0 !== e.dom.attachedTo && e._attach(e.dom.attachedTo)
            }

            return f(r).on("orientationchange", function () {
                setTimeout(function () {
                    o(), setTimeout(o, 150)
                }, 50)
            }), this
            ...
            var t = this, e = this.s.dt, o = f("div.dataTables_scrollBody", this.s.dt.table().container());
            e.settings()[0].autoFill = this, o.length && "static" === (this.dom.dtScroll = o).css("position") && o.css("position", "relative"), !1 !== this.c.enable && this.enable(), e.on("destroy.autoFill", function () {
                t._focusListenerRemove()
            })
        }, _attach: function (t) {
            var e = this.s.dt, o = e.cell(t).index(), i = this.dom.handle, n = this.s.handle;
            o && -1 !== e.columns(this.c.columns).indexes().indexOf(o.column) ? (this.dom.offsetParent || (this.dom.offsetParent = f(e.table().node()).offsetParent()), n.height && n.width || (i.appendTo("body"), n.height = i.outerHeight(), n.width = i.outerWidth()), o = this._getPosition(t, this.dom.offsetParent), this.dom.attachedTo = t, i.css({
            ...
            var t, i, n = this, l = this.s.dt, s = d.actions, a = [];
            f.each(s, function (t, e) {
                e.available(l, o) && a.push(t)
            }), 1 === a.length && !1 === this.c.alwaysAsk ? (t = s[a[0]].execute(l, o), this._update(t, o)) : (1 < a.length || this.c.alwaysAsk) && (i = this.dom.list.children("div.dt-autofill-list-items").empty(), a.push("cancel"), f.each(a, function (t, e) {
                i.append(f("<button/>").html(s[e].option(l, o)).append(f('<span class="dt-autofill-button"/>').html(l.i18n("autoFill.button", "&gt;"))).on("click", function (t) {
                    "button" === t.target.nodeName.toLowerCase() && (t = s[e].execute(l, o, f(this).closest("button")), n._update(t, o), n.dom.background.remove(), n.dom.list.remove())
                }))
            }), this.dom.background.appendTo("body"), this.dom.background.one("click", function () {
                n.dom.background.remove(), n.dom.list.remove()
            }), this.dom.list.appendTo("body"), this.c.closeButton && (this.dom.list.prepend(this.dom.closeButton).addClass(d.classes.closeable), this.dom.closeButton.on("click", function () {
                return n.dom.background.click()
            })), this.dom.list.css("margin-top", this.dom.list.outerHeight() / 2 * -1))
        }, _detach: function () {
            this.dom.attachedTo = null, this.dom.handle.detach()
        }, _drawSelection: function (t, e) {
            var o, i = this.s.dt, n = this.s.start, l = f(this.dom.start), t = {
                    row: this.c.vertical ? i.rows({page: "current"}).nodes().indexOf(t.parentNode) : n.row,
                    column: this.c.horizontal ? f(t).index() : n.column
                }, s = i.column.index("toData", t.column), a = i.row(":eq(" + t.row + ")", {page: "current"}),
            ...
            i.cell(a).any() && -1 !== i.columns(this.c.columns).indexes().indexOf(s) && -1 !== t.row && (this.s.end = t, i = n.row < t.row ? l : a, s = n.row < t.row ? a : l, o = n.column < t.column ? l : a, n = n.column < t.column ? a : l, i = this._getPosition(i.get(0)).top, o = this._getPosition(o.get(0)).left, t = this._getPosition(s.get(0)).top + s.outerHeight() - i, a = this._getPosition(n.get(0)).left + n.outerWidth() - o, (l = this.dom.select).top.css({
                ...
                left: o,
                width: a
            }), l.left.css({top: i, left: o, height: t}), l.bottom.css({
                top: i + t,
                left: o,
                width: a
            }), l.right.css({top: i, left: o + a, height: t}))
        }, _editor: function (t) {
            var e = this.s.dt, o = this.c.editor;
            if (o) {
                for (var i = {}, n = [], l = o.fields(), s = 0, a = t.length; s < a; s++) for (var d = 0, r = t[s].length; d < r; d++) {
                    var c = t[s][d], u = e.settings()[0].aoColumns[c.index.column], h = u.editField;
                    if (void 0 === h) for (var f = u.mData, m = 0, p = l.length; m < p; m++) {
                        var v = o.field(l[m]);
                        if (v.dataSrc() === f) {
                            h = v.name();
                            break
                ...
                o.bubble(n, !1).multiSet(i).submit(null, function () {
                    o.close()
                })
            }
            ...
            var i = this, e = this.s.dt, t = this.s.namespace,
            ...
            "focus" === o ? e.on("key-focus.autoFill", function (t, e, o) {
                ...
                i._detach()
            }) : "click" === o ? (f(e.table().body()).on("click" + t, "td, th", function (t) {
                i._attach(this)
            }), f(m.body).on("click" + t, function (t) {
                f(t.target).parents().filter(e.table().body()).length || i._detach()
            })) : f(e.table().body()).on("mouseenter" + t + " touchstart" + t, "td, th", function (t) {
                i._attach(this)
            ...
            do {
                var l = o.offsetTop, s = o.offsetLeft, a = f(o.offsetParent)
            ...
            var e = this, o = this.s.dt, i = (this.dom.start = this.dom.attachedTo, this.s.start = {
                    row: o.rows({page: "current"}).nodes().indexOf(f(this.dom.start).parent()[0]),
                    column: f(this.dom.start).index()
                }, f(m.body).on("mousemove.autoFill touchmove.autoFill", function (t) {
                    e._mousemove(t), "touchmove" === t.type && f(m.body).one("touchend.autoFill", function () {
                        e._detach()
                    })
                }).on("mouseup.autoFill touchend.autoFill", function (t) {
                    e._mouseup(t)
                }), this.dom.select), o = f(o.table().node()).offsetParent(),
            ...
            var e = t.touches && t.touches.length ? m.elementFromPoint(t.touches[0].clientX, t.touches[0].clientY) : t.target,
                o = e.nodeName.toLowerCase();
            "td" !== o && "th" !== o || (this._drawSelection(e, t), this._shiftScroll(t))
        }, _mouseup: function (t) {
            f(m.body).off(".autoFill");
            var e = this, n = this.s.dt, o = this.dom.select,
            ...
            if (o.row !== i.row || o.column !== i.column) {
                var l, s = n.cell(":eq(" + o.row + ")", o.column + ":visible", {page: "current"});
                if (f("div.DTE", s.node()).length) (l = n.editor()).on("submitSuccess.dtaf close.dtaf", function () {
                    ...
                    for (var a = this._range(o.row, i.row), d = this._range(o.column, i.column), r = [], c = n.settings()[0].aoColumns, u = n.columns(this.c.columns).indexes(), h = 0; h < a.length; h++) r.push(f.map(d, function (t) {
                        var e = n.row(":eq(" + a[h] + ")", {page: "current"}), e = n.cell(e.index(), t + ":visible"),
                            t = e.data(), o = e.index(), i = c[o.column].editField;
                        if (void 0 !== i && (t = p.util.get(i)(n.row(o.row).data())), -1 !== u.indexOf(o.column)) return {
                            cell: e,
                            data: t,
                            label: e.data(),
                            index: o
            ...
            var o, i = [];
            if (t <= e) for (o = t; o <= e; o++) i.push(o); else for (o = t; e <= o; o--) i.push(o);
            return i
        }, _shiftScroll: function (t) {
            var e, o, i, n, l = this, s = this.s.scroll, a = !1,
        ...
        increment: {
            available: function (t, e) {
                ...
                for (var i = +e[0][0].data, n = +f("input", o).val(), l = 0, s = e.length; l < s; l++) for (var a = 0, d = e[l].length; a < d; a++) e[l][a].set = i, i += n
            }
        }, fill: {
            available: function (t, e) {
                return !0
        ...
        vertical: !0,
        horizontal: !0
    }, d.classes = {btn: "btn", closeable: "dtaf-popover-closeable"}, f.fn.dataTable.Api);
    return t.register("autoFill()", function () {
        ...
        var i, n;
        "dt" === t.namespace && (t = e.oInit.autoFill, i = p.defaults.autoFill, t || i) && (n = f.extend({}, t, i), !1 !== t) && new d(e, n)
    }), p.AutoFill = d, f.fn.DataTable.AutoFill = d, p
});
...
!function (n) {
    ...
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-autofill"], function (e) {
        ...
        t.fn.dataTable || require("datatables.net-bs5")(e, t), t.fn.dataTable.AutoFill || require("datatables.net-autofill")(e, t)
    }, "undefined" == typeof window ? module.exports = function (e, t) {
        return e = e || window, t = t || o(e), a(e, t), n(t, 0, e.document)
    } : (a(window, o), module.exports = n(o, window, window.document))) : n(jQuery, window, document)
}(function (e, t, n) {
...
!function (s) {
    ...
    return g.extend(n.prototype, {
        destroy: function () {
            ...
            return void 0 === t ? this.s.d : (t instanceof Date ? this.s.d = this._dateToUtc(t) : null === t || "" === t ? this.s.d = null : "--now" === t ? this.s.d = this._dateToUtc(new Date) : "string" == typeof t && (this.s.d = this._dateToUtc(this._convert(t, this.c.format, null))), !e && void 0 !== e || (this.s.d ? this._writeOutput() : this.dom.input.val(t)), this.s.display = this.s.d ? new Date(this.s.d.toString()) : new Date, this.s.display.setUTCDate(1), this._setTitle(), this._setCalander(), this._setTime(), this)
            ...
            this.s.parts.date || this.dom.date.css("display", "none"), this.s.parts.time || this.dom.time.css("display", "none"), this.s.parts.seconds || (this.dom.time.children("div." + r + "-seconds").remove(), this.dom.time.children("span").eq(1).remove()), this.c.buttons.clear || this.dom.clear.css("display", "none"), this.c.buttons.today || this.dom.today.css("display", "none"), this._optionsTitle(), g(i).on("i18n.dt", function (t, e) {
                ...
                if ("select" !== i) if (t.stopPropagation(), "a" === i && (t.preventDefault(), g(s).hasClass(r + "-clear") ? (o.s.d = null, o.dom.input.val(""), o._writeOutput(), o._setCalander(), o._setTime(), a()) : g(s).hasClass(r + "-today") && (o.s.display = new Date, o._setTitle(), o._setCalander())), "button" === i) {
                    t = g(s), i = t.parent();
            ...
            for (var u = 0, c = 0; u < r; u++) {
                var m = new Date(Date.UTC(t, e, u - n + 1)), f = !!this.s.d && this._compareDates(m, this.s.d),
                    p = this._compareDates(m, s), y = u < n || i + n <= u, T = l && m < l || h && h < m,
                    v = this.c.disableDays, f = {
                        day: u - n + 1,
                        month: e,
                        year: t,
                        selected: f,
                        today: p,
                        disabled: T = Array.isArray(v) && -1 !== g.inArray(m.getUTCDay(), v) || "function" == typeof v && !0 === v(m) ? !0 : T,
                        empty: y
                    };
                o.push(this._htmlDay(f)), 7 == ++c && (this.c.showWeekNumber && o.unshift(this._htmlWeekOfYear(u - n, e, t)), a.push("<tr>" + o.join("") + "</tr>"), o = [], c = 0)
            }
            var _, D = this.c.classPrefix, C = D + "-table";
            ...
            var e, d = this.c.classPrefix, s = this.dom.container.find("div." + d + "-" + n),
                i = 12 === a ? function (t) {
                    return t
                } : this._pad, l = d + "-table", h = this.c.i18n;
            if (s.length) {
                var u = "", c = 10, m = function (t, e, s) {
            ...
            var e = this.s.d, s = "", i = this.dom.input,
        ...
        showWeekNumber: !1,
        yearRange: 25
    }, n.version = "1.5.2", n.factory = function (t, e) {
        var s = !1;
