...
class DossierModifType extends  ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
         ...
         //   ->add('intituleObjet')
//            ->add('intituleObjet', TextareaType::class,$this->getConfiguration("Nature de la décision attaquée", "Saissez l\intitulé de l'objet", ['required' => true]))
